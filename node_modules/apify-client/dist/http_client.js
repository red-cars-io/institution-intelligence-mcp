...
class HttpClient {
    ...
    async initNode() {
        if (!(0, utils_1.isNode)())
            return;
        const [{ ProxyAgent }, os] = await Promise.all([Promise.resolve().then(() => tslib_1.__importStar(require('proxy-agent'))), Promise.resolve().then(() => tslib_1.__importStar(require('node:os')))]);
